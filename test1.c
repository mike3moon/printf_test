...
char	*read_flag(const char *format, tag *ap_tag)
{
...
char	*read_width(const char *format, tag *ap_tag, va_list ap)
{
...
char	*read_precision(const char *format, tag *ap_tag, va_list ap)
{
	if (*format == '.')
	{
		format++;
...
char	*read_type(const char *format, tag *ap_tag)
{
	if (*format == 'c')
		ap_tag->type = 'c';
	else if (*format == 's')
...
char	*read_tag(const char *format, tag *ap_tag, va_list ap)
{
...
int	write_char(int c, tag *ap_tag, int *ret)
{
	int	width;
...
int	print_string(char *str, tag *ap_tag, int *ret)
{
	int	width;
	int	prec;
...
char	*write_ap(const char *format, va_list ap, int *ret)
{
	tag	*ap_tag;
